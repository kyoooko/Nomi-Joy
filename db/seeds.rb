...
User.create!(name:"能美ジョイ男", email: "test2@test.co.jp", password: "aaaaaa", nomi_joy_id:"nomijoy2", belongs: "パシフィックインターナショナル ", position: "代表取締役",image:"",nearest_station:"恵比寿", can_drink: true, favolite:"ビール、ワイン",unfavolite:"生魚", introduction:"麻布十番・恵比寿・代官山開拓中です！クラフトビール にハマっています！ぜひお声がけください！")

User.create!(name:"能美ジョー", email: "test3@test.co.jp", password: "aaaaaa", nomi_joy_id:"nomijoy3", belongs: "日本セラミック（株） ", position: "主任",image:File.open("./app/assets/images/Kanjino-Heya.png", ?r),nearest_station:"要町", can_drink: false, favolite:"刺身",unfavolite:"パクチー、納豆", introduction:"どうぞよろしくお願いします。")
